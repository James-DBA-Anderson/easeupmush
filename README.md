...
- Standalone static site: `npm run build` → `dist/`
...
1. Push to GitHub (Pages enabled).
2. **Settings → Pages → Source:** GitHub Actions.
3. Push to `main` (or run **Deploy site**). Site URL appears on the workflow run.

Custom domain: put the domain in `public/CNAME`, then point DNS at GitHub Pages.
